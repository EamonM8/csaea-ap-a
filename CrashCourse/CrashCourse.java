...
public class CrashCourse {     // class header
    ...
    public static void main(String[] args) {
        ...
        // Math Class (dont have to import since its common)
        // Math. <-- dot operator
        Math.max(5, 9); // max value --> retunrs 9
        ...
        // initialize variable for an index; conditional; increment/decrement
         ...
         animals.add("Sheep"); animals.add("Deer"); animals.add("Moose");
         ...
         System.out.println("Memory Addess: " + arry);
         ...
         for (int row = 0;  row < arryMatrix.length; row++) {
            for (int columns = 0; columns < arryMatrix[row].length; columns++) {
                System.out.print(arryMatrix[row][columns] + " ");
